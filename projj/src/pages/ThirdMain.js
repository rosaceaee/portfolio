...
const ThirdMain = ({ langu }) => {
  ...
  const Asdf = ({ name, position, infodesc, infodescTwo }) => {
    return (
        ...
        <section style={{ margin: "0 1rem" }}>
          <section className="works-container">
            ...
            <Masonry columnsCount={3}>
              {worksTit2 &&
                worksTit2.map((a, index, key, descc) => {
                  return (
                    <>
                      {" "}
  ...
  return (
    <>
      <main id="main" className="maincon">
        ...
        <footer>
          <a href="mail: liliaceaeeee@gmail.com" target="_blank"></a>
          <a href="https://github.com/rosaceaee/" target="_blank"></a>
        </footer>
      </main>
    </>
  );
