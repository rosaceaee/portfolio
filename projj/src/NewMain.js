...
const NewMain = () => {
  ...
  function reveal() {
    var reveals = document.querySelectorAll(".main-center-con");
    const menu = document.querySelectorAll(".left-nav h3");
    for (var i = 0; i < reveals.length; i++) {
      ...
      if (elementTop < windowHeight - elementVisible) {
        ...
        menu[i].classList.add("chk-position-nav");
        if (i) {
          menu[i].classList.add("chk-position-nav");
        } else if (menu[1].classList.contains("chk-position-nav")) {
          menu[0].classList.remove("chk-position-nav");
        }
      } else {
        menu[i].classList.remove("chk-position-nav");
      }
    }
  }
  ...
  function height() {
    ...
    document.addEventListener("scroll", function () {
      document.addEventListener("scroll", function () {
        ...
        // box.style.background = `rgb(${colorValue + 0},0,${colorValue - 20})`;
      });
                  ...
                  <span>
                    ...
                    <div className="greeting">
                      ...
                      <div className="desc">
                        ...
                        <p>
                          만드는 것을 좋아하고, UI에 관심이 많은 웹 퍼블리셔.
                          web publisher, who loves make anything, especially UI
                          design, development.
                        </p>
  ...
  function BeforeShow() {
    ...
    return (
      <main id="main">
        {!isHide ? <Landing /> : <MainBox setLang={setLang} />}{" "}
      </main>
    );
  }
